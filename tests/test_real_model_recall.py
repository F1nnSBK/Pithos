...
class TestRealModelRecall(unittest.TestCase):

    def test_real_matryoshka_recall(self):
        np.random.seed(1337)
        dim = 256
        num_db = 5_000
        num_queries = 50
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with VectorDb() as db:
                ...
                self.assertGreaterEqual(recall_10, 80.0, f"Expected Recall@10 >= 80.0%, got {recall_10:.2f}%")
